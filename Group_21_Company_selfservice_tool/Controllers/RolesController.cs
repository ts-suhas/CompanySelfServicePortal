...
namespace Group_21_Company_selfservice_tool.Controllers
{
    public class RolesController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "Role_ID,Role_Type,Description")] Role role)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Role_ID,Role_Type,Description")] Role role)
        {
            if (ModelState.IsValid)
            {
